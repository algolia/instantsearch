  ...
  it('calls twice ReactDOM.render(<RefinementList props />, container)', () => {
    ...
    let props = {
      cssClasses: {
        ...
        link: 'ais-refinement-list--link',
        list: 'ais-refinement-list--list',
        root: 'ais-refinement-list'
      },
      facetValues: [
        {isRefined: true, name: 'All'},
        {end: 4, isRefined: false, name: 'less than 4'},
        {end: 4, isRefined: false, name: '4', start: 4},
        {end: 10, isRefined: false, name: 'between 5 and 10', start: 5},
        {isRefined: false, name: 'more than 10', start: 10}
      ],
      createURL: () => {},
      toggleRefinement: () => {},
      shouldAutoHideContainer: false,
      templateProps: {
        templates: {footer: '', header: '', item: '<a class="{{cssClasses.link}}" href="{{url}}">{{name}}'},
