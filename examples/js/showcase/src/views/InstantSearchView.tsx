    ...
    <SearchContext.Provider value={searchRef.current}>
      <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-2 md:flex-row">
          ...
          <WidgetSwitcher
            class="flex-1"
            widgets={[{ title: 'stats', body: WidgetStats }]}
          />
          <WidgetSwitcher
            class="flex-1"
            widgets={[{ title: 'sortBy', body: WidgetSortBy }]}
          />
          <WidgetSwitcher
            class="flex-1"
        ...
        <div class="flex flex-col gap-2 sm:flex-row">
          <WidgetSwitcher
            class="shrink-0"
            widgets={[
              { title: 'clearRefinements', body: WidgetClearRefinements },
            ]}
          />
          <WidgetSwitcher
            class="flex-1"
            widgets={[
              { title: 'currentRefinements', body: WidgetCurrentRefinements },
            ]}
          />
        </div>
        ...
        <div class="flex flex-col gap-2 sm:flex-row">
          <div class="w-full shrink-0 sm:max-w-[296px]">
            <WidgetSwitcher
              widgets={[{ title: 'dynamicWidgets', body: DynamicWidgets }]}
            />
          </div>
          ...
          <div class="flex flex-1 flex-col gap-2">
            ...
            <WidgetSwitcher
              widgets={[{ title: 'configure', body: WidgetConfigure }]}
            />
          </div>
        </div>
      </div>
