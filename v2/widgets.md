...
</div><script>window.instantsearch = instantsearch;
...
});</script><h2 id="basic">Most common widgets<a class="anchor" href="undefined#basic"></a></h2><h3 id="basic-hits">hits<a class="anchor" href="undefined#basic-hits"></a></h3><p><a href="widgets/hits.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="hits-container"></div><script>search.addWidget(
...
);</script><h3 id="basic-hitsPerPageSelector">hitsPerPageSelector<a class="anchor" href="undefined#basic-hitsPerPageSelector"></a></h3><p><a href="widgets/hitsPerPageSelector.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="hits-per-page-selector"></div><script>search.addWidget(
...
);</script><h3 id="basic-infiniteHits">infiniteHits<a class="anchor" href="undefined#basic-infiniteHits"></a></h3><p><a href="widgets/infiniteHits.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="infinite-hits-container"></div><script>search.addWidget(
...
);</script><h2 id="navigation">Navigational widgets<a class="anchor" href="undefined#navigation"></a></h2><h3 id="navigation-pagination">pagination<a class="anchor" href="undefined#navigation-pagination"></a></h3><p><a href="widgets/pagination.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="pagination-container"></div><script>search.addWidget(
...
);</script><h2 id="filter">Filtering widgets<a class="anchor" href="undefined#filter"></a></h2><h3 id="filter-hierarchicalMenu">hierarchicalMenu<a class="anchor" href="undefined#filter-hierarchicalMenu"></a></h3><p><a href="widgets/hierarchicalMenu.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="hierarchical-categories"></div><script>search.addWidget(
...
);</script><h3 id="filter-menu">menu<a class="anchor" href="undefined#filter-menu"></a></h3><p><a href="widgets/menu.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="categories"></div><script>search.addWidget(
...
);</script><h3 id="filter-refinementList">refinementList<a class="anchor" href="undefined#filter-refinementList"></a></h3><p><a href="widgets/refinementList.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="brands"></div><script>search.addWidget(
...
);</script><h3 id="filter-numericRefinementList">numericRefinementList<a class="anchor" href="undefined#filter-numericRefinementList"></a></h3><p><a href="widgets/numericRefinementList.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="popularity"></div><script>search.addWidget(
...
);</script><h3 id="filter-numericSelector">numericSelector<a class="anchor" href="undefined#filter-numericSelector"></a></h3><p><a href="widgets/numericSelector.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="popularity-selector"></div><script>search.addWidget(
...
);</script><h3 id="filter-priceRanges">priceRanges<a class="anchor" href="undefined#filter-priceRanges"></a></h3><p><a href="widgets/priceRanges.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="price-ranges"></div><script>search.addWidget(
...
);</script><h3 id="filter-rangeSlider">rangeSlider<a class="anchor" href="undefined#filter-rangeSlider"></a></h3><p><a href="widgets/rangeSlider.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="price"></div><script>search.addWidget(
...
);</script><h3 id="filter-starRating">starRating<a class="anchor" href="undefined#filter-starRating"></a></h3><p><a href="widgets/starRating.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="stars"></div><script>search.addWidget(
...
);</script><h3 id="filter-toggle">toggle<a class="anchor" href="undefined#filter-toggle"></a></h3><p><a href="widgets/toggle.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="free-shipping"></div><script>search.addWidget(
...
);</script><h2 id="clear-filter">Clearing widgets<a class="anchor" href="undefined#clear-filter"></a></h2><h3 id="clear-filter-clearAll">clearAll<a class="anchor" href="undefined#clear-filter-clearAll"></a></h3><p><a href="widgets/clearAll.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="clear-all"></div><script>search.addWidget(
...
);</script><h3 id="clear-filter-currentRefinedValues">currentRefinedValues<a class="anchor" href="undefined#clear-filter-currentRefinedValues"></a></h3><p><a href="widgets/currentRefinedValues.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="current-refined-values"></div><script>search.addWidget(
...
);</script><h2 id="sort">Sorting widgets<a class="anchor" href="undefined#sort"></a></h2><h3 id="sort-sortBySelector">sortBySelector<a class="anchor" href="undefined#sort-sortBySelector"></a></h3><p><a href="widgets/sortBySelector.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="sort-by-container"></div><script>search.addWidget(
...
);</script><h2 id="metadata">Metadata widgets<a class="anchor" href="undefined#metadata"></a></h2><h3 id="metadata-stats">stats<a class="anchor" href="undefined#metadata-stats"></a></h3><p><a href="widgets/stats.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="stats-container"></div><script>search.addWidget(
  instantsearch.widgets.stats({
    container: '#stats-container'
  })
);</script><h2 id="analytics">Analytics widgets<a class="anchor" href="undefined#analytics"></a></h2><h3 id="analytics-analytics">analytics<a class="anchor" href="undefined#analytics-analytics"></a></h3><p><a href="widgets/analytics.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel">This widget does not have a displayed output.</div><h2 id="other">Other widgets<a class="anchor" href="undefined#other"></a></h2><h3 id="other-searchBox">searchBox<a class="anchor" href="undefined#other-searchBox"></a></h3><p><a href="widgets/searchBox.html">Full documentation</a></p><div class="example-tile elevation1 radius6 p-large pos-rel" id="q"></div><script>search.addWidget(
