...
export function createOptionsTests(
  ...
  describe('options', () => {
    ...
    describe('tools', () => {
      ...
      test('passes loaderComponent to tool layout components', async () => {
        const searchClient = createSearchClient();
          ...
          widgetParams: {
            javascript: {
              ...
              tools: {
                hello: {
                  templates: {
                    layout: ({ loader }: any, { html }: any) =>
                      html`<div id="tool-with-loader">
                        ${loader ? loader() : null}
                      </div>`,
                  },
                },
              ...
              tools: {
                hello: {
                  layoutComponent: ({
                    ...
                    loaderComponent?: (props: any) => React.ReactElement;
                  }) => (
                    <div id="tool-with-loader">
                      {Loader ? <Loader /> : null}
                    </div>
                  ),
                },
        ...
        expect(
          document.querySelector('#tool-with-loader')
        ).toBeInTheDocument();
        expect(
          document.querySelector(
            '#tool-with-loader .ais-ChatMessageLoader'
          )
        ).toBeInTheDocument();
      });

      test('loaderComponent renders custom loader when messagesLoaderComponent is provided', async () => {
        const searchClient = createSearchClient();
        ...
        await setup({
          ...
          widgetParams: {
            javascript: {
              ...
              tools: {
                hello: {
                  templates: {
                    layout: ({ loader }: any, { html }: any) =>
                      html`<div id="tool-custom-loader">
                        ${loader ? loader() : null}
                      </div>`,
                  },
                },
            ...
            react: {
              ...createDefaultWidgetParams(chat),
              messagesLoaderComponent: CustomLoader,
              tools: {
                hello: {
                  layoutComponent: ({
                    loaderComponent: Loader,
        ...
        expect(
          document.querySelector('#tool-custom-loader')
        ).toBeInTheDocument();
        expect(
          document.querySelector('#tool-custom-loader .custom-loader')
        ).toBeInTheDocument();
      });
