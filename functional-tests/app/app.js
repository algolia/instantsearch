...
function player() {
  const coldQueries = {
    '[{"indexName":"instant_search","params":{"query":"","hitsPerPage":6,"maxValuesPerFacet":10,"page":0,"facets":["price_range","price","brand","free_shipping","price","categories","hierarchicalCategories.lvl0","categories","hierarchicalCategories.lvl0"],"tagFilters":"","numericFilters":["popularity>=0"]}}]':
    ...
    '[{"indexName":"instant_search","params":{"query":"m","hitsPerPage":6,"maxValuesPerFacet":10,"page":0,"facets":["price_range","price","brand","free_shipping","price","categories","hierarchicalCategories.lvl0","categories","hierarchicalCategories.lvl0"],"tagFilters":"","numericFilters":["popularity>=0"]}}]':
    ...
    '[{"indexName":"instant_search","params":{"query":"mp","hitsPerPage":6,"maxValuesPerFacet":10,"page":0,"facets":["price_range","price","brand","free_shipping","price","categories","hierarchicalCategories.lvl0","categories","hierarchicalCategories.lvl0"],"tagFilters":"","numericFilters":["popularity>=0"]}}]':
    ...
    '[{"indexName":"instant_search","params":{"query":"mp3","hitsPerPage":6,"maxValuesPerFacet":10,"page":0,"facets":["price_range","price","brand","free_shipping","price","categories","hierarchicalCategories.lvl0","categories","hierarchicalCategories.lvl0"],"tagFilters":"","numericFilters":["popularity>=0"]}}]':
