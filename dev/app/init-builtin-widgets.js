...
export default () => {
  storiesOf('Analytics').add('default', wrapWithHits(container => {
  ...
  storiesOf('SearchBox')
    ...
    .add('search on enter', wrapWithHits(container => {
      window.search.addWidget(
        instantsearch.widgets.searchBox({
          container,
          placeholder: 'Search for products',
  ...
  storiesOf('Stats').add('default', wrapWithHits(container => {
    window.search.addWidget(
      instantsearch.widgets.stats({container})
    );
  }));

  storiesOf('SortBySelector').add('default', wrapWithHits(container => {
    window.search.addWidget(
  ...
  storiesOf('HitsPerPageSelector').add('default', wrapWithHits(container => {
    window.search.addWidget(
  ...
  storiesOf('Hits').add('default', wrapWithHits(container => {
    window.search.addWidget(
      instantsearch.widgets.hits({container})
    );
  }));

  storiesOf('InfiniteHits').add('default', wrapWithHits(container => {
    window.search.addWidget(
  ...
  storiesOf('Pagination').add('default', wrapWithHits(container => {
    window.search.addWidget(
  ...
  storiesOf('RefinementList')
    ...
    .add('with show more', wrapWithHits(container => {
      window.search.addWidget(
        instantsearch.widgets.refinementList({
          container,
          attributeName: 'brand',
    ...
    .add('with search inside items', wrapWithHits(container => {
      window.search.addWidget(
        instantsearch.widgets.refinementList({
          container,
          attributeName: 'brand',
    ...
    .add('with operator `and`', wrapWithHits(container => {
      window.search.addWidget(
        instantsearch.widgets.refinementList({
          container,
  ...
  storiesOf('StarRating').add('default', wrapWithHits(container => {
    window.search.addWidget(
  ...
  storiesOf('NumericRefinementList').add('default', wrapWithHits(container => {
    window.search.addWidget(
  ...
  storiesOf('Toggle')
    .add('with single value', wrapWithHits(container => {
      window.search.addWidget(
    ...
    .add('with on & off values', wrapWithHits(container => {
      window.search.addWidget(
        instantsearch.widgets.toggle({
          container,
          attributeName: 'brand',
  ...
  storiesOf('NumericSelector').add('default', wrapWithHits(container => {
    window.search.addWidget(
