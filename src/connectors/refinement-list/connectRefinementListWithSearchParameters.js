  ...
  return (widgetParams = {}) => {
    ...
    return {
      ...
      getConfiguration: searchParameters => {
        ...
        const withMaxValuesPerFacet = searchParameters.setQueryParameter(
          'maxValuesPerFacet',
          nextMaxValuesPerFacet
        );

        if (operator === 'and') {
          return withMaxValuesPerFacet.addFacet(attribute);
        }

        return withMaxValuesPerFacet.addDisjunctiveFacet(attribute);
      },
