...
// -> provides same instantsearch object as es5 or <script> build
export default main;

// import { instantsearch } from 'instantsearch.js';
// -> provides instantsearch object without connectors and widgets
export const instantsearch = Object.assign(toFactory(InstantSearch), {
  version: main.version,
  createQueryString: main.createQueryString,
});
