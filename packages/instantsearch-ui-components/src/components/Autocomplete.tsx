...
export type AutocompleteProps = {
  ...
  items: string[];
  placeholder?: string;
  panelComponent: React.ElementType<any>;
};

export function createAutocompleteComponent({
  createElement,
  Fragment,
}: Renderer) {
  return function Autocomplete(userProps: AutocompleteProps) {
    ...
    return (
      <Fragment>
        ...
        >
          <form className="aa-Form" action="" noValidate role="search">
            <div className="aa-InputWrapperPrefix">
              <label className="aa-Label" aria-label="Submit">
                <button
        ...
        <div className="aa-Panel" hidden={!isOpen}>
          {PanelComponent ? (
            // @ts-ignore
                      ...
                      <div className="aa-ItemWrapper">
                        <div className="aa-ItemContent">
                          ...
                          <div className="aa-ItemContentBody">
                            <div className="aa-ItemContentTitle">{item}</div>
                          </div>
                        </div>
