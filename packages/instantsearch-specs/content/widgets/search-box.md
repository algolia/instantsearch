  ...
  <div class="ais-SearchBox">
    ...
    <div class="ais-SearchBox-body ais-body">
      <form class="ais-SearchBox-form" novalidate>
        <input class="ais-SearchBox-input" autocomplete="off" placeholder="Search for products" spellcheck="false" maxlength="512" type="text" value="" />
...
althtml1: |
  <div class="ais-SearchBox">
    ...
    <div class="ais-SearchBox-body ais-body">
      <form class="ais-SearchBox-form" novalidate>
        <input class="ais-SearchBox-input" autocomplete="off" placeholder="Search for products" spellcheck="false" maxlength="512" type="text" value="Typing text..." />
