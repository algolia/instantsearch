...
import MenuSelectComponent from './MenuSelect';
 ...
 */
const Menu = connect(MenuComponent);
/**
 * The MenuSelect component displays a dropdown menu that lets the user choose a single value for a specific facet.
 * @kind component
 * @category widget
 * @propType {string} id - the id of the widget
 * @propType {string} attributeName - the name of the attribute in the record
 ...
 * @translationkey showMore - The label of the show more button. Accepts one parameters, a boolean that is true if the values are expanded
 */
Menu.Select = connect(MenuSelectComponent);
