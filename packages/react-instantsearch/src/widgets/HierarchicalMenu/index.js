/**
 * @module widget/HierarchicalMenu
 */
import connect from './connect';
import HierarchicalMenuComponent from './HierarchicalMenu';
 ...
 * }
 */
const HierarchicalMenu = connect(HierarchicalMenuComponent);
HierarchicalMenu.connect = connect;
