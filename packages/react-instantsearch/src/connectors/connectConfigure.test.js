...
describe('connectConfigure', () => {
  ...
  describe('multi index', () => {
    let context = {context: {ais: {mainTargetedIndex: 'first'}, multiIndexContext: {targetedIndex: 'second'}}};
    ...
    it('calling transitionState should add configure parameters to the search state', () => {
      ...
      expect(searchState).toEqual({indices: {second: {configure: {distinct: 1, whatever: 'please'}}}});
      ...
      context = {context: {ais: {mainTargetedIndex: 'first'}, multiIndexContext: {targetedIndex: 'first'}}};
      ...
      searchState = transitionState(
        {whatever: 'other', children: 'whatever'},
        {indices: {second: {configure: {whatever: 'other'}}, first: {configure: {distinct: 1, whatever: 'please'}}}},
        {indices: {second: {configure: {whatever: 'other'}}, first: {configure: {distinct: 1, whatever: 'please'}}}},
      );
    ...
    it('calling cleanUp should remove configure parameters from the search state', () => {
      ...
      searchState = cleanUp(
        {distinct: 1, whatever: 'please', children: 'whatever'},
        {indices: {first: {configure: {distinct: 1, whatever: 'please'}}, second: {configure: {}}}}
      );
      expect(searchState).toEqual({indices: {first: {configure: {}}, second: {configure: {}}}});
    });
  });
});
