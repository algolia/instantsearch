  ...
  describe('getWidgetRenderState', () => {
    ...
    it('warns when facets is unset and more than 20 items are returned from attributesToDisplay', () => {
      ...
      expect(() =>
        ...
        '[InstantSearch]: More than 20 facets are requested to be displayed without explicitly setting which facets to retrieve. This could have a performance impact. Set "facets" to [] to do two smaller network requests, or explicitly to [\'*\'] to avoid this warning.'
      );
    });
    ...
    it('warns when a widget sets a higher limit than dynamic widgets', () => {
      ...
      expect(() =>
        ...
        '[InstantSearch]: The maxValuesPerFacet set by dynamic widgets (20) is smaller than one of the limits set by a widget (100). This causes a mismatch in query parameters and thus an extra network request when that widget is mounted.'
      );
    });
  });
