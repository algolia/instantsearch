...
describe('createMetadataMiddleware', () => {
  ...
  describe('metadata enabled', () => {
    ...
    it('fills it with widgets after start', async () => {
      ...
      search.addWidgets([
        { ...connectSearchBox(() => {})({}), $$widgetType: 'ais.searchBox' },
        { ...connectSearchBox(() => {})({}), $$widgetType: 'custom.searchBox' },
        {
          ...connectHits(() => {})({ escapeHTML: true }),
          $$widgetType: 'ais.hits',
        },
        index({ indexName: 'test2' }).addWidgets([
          {
            ...connectPagination(() => {})({ padding: 50 }),
      ...
      expect(document.head).toMatchInlineSnapshot(`
        <head>
          <meta
            content="{\\"widgets\\":[{\\"type\\":\\"ais.searchBox\\",\\"widgetType\\":\\"ais.searchBox\\",\\"params\\":[]},{\\"type\\":\\"ais.searchBox\\",\\"widgetType\\":\\"custom.searchBox\\",\\"params\\":[]},{\\"type\\":\\"ais.hits\\",\\"widgetType\\":\\"ais.hits\\",\\"params\\":[\\"escapeHTML\\"]},{\\"type\\":\\"ais.index\\",\\"widgetType\\":\\"ais.index\\",\\"params\\":[]},{\\"type\\":\\"ais.pagination\\",\\"widgetType\\":\\"ais.pagination\\",\\"params\\":[\\"padding\\"]},{\\"type\\":\\"ais.configure\\",\\"widgetType\\":\\"ais.configure\\",\\"params\\":[\\"searchParameters\\"]},{\\"middleware\\":true,\\"type\\":\\"ais.metadata\\",\\"internal\\":true}]}"
    ...
    describe('fills it with user agent after start', () => {
      it('for the v5 client', async () => {
        ...
        expect(
          ...
          expect.stringMatching(/instantsearch-core \(0\..*\)/),
