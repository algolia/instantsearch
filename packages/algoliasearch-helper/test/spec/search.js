...
test('Search should call the algolia client according to the number of refinements', function () {
...
test('Search should not mutate the original client response', function () {
  return new Promise(function (done) {
    var testData = require('../datasets/SearchParameters/search.dataset')();
