...
test('When searchOnce with callback, hasPendingRequests is true', function () {
...
test('When searchOnce with promises, hasPendingRequests is true', function () {
  return new Promise(function (done) {
    var testData = require('../../datasets/SearchParameters/search.dataset')();
    var client = algoliasearch('dsf', 'dsfdf');
...
if (!isV5) {
  test('When searchForFacetValues, hasPendingRequests is true (v3, v4)', function () {
    return new Promise(function (done) {
      var client = algoliasearch('dsf', 'dsfdf');
  ...
  test('When searchForFacetValues, hasPendingRequests is true (v5)', function () {
    return new Promise(function (done) {
      var client = algoliasearch('dsf', 'dsfdf');
...
test('When helper.search(), hasPendingRequests is true', function () {
  return new Promise(function (done) {
    var testData = require('../../datasets/SearchParameters/search.dataset')();
    var client = algoliasearch('dsf', 'dsfdf');
...
test('When helper.search() and one request is discarded, hasPendingRequests is true unless all come back', function () {
  return new Promise(function (done) {
    var testData = require('../../datasets/SearchParameters/search.dataset')();
    var client = algoliasearch('dsf', 'dsfdf');
