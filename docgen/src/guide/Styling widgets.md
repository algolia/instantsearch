...
- unminified: https://unpkg.com/react-instantsearch-theme-algolia@2.0.0-beta.21/style.css
- minified: https://unpkg.com/react-instantsearch-theme-algolia@2.0.0-beta.21/style.min.css

You can either copy paste the content in your own app or use a direct link to unpkg.com:

```html
<link rel="stylesheet" href="https://unpkg.com/react-instantsearch-theme-algolia@2.0.0-beta.21/style.min.css">
```
