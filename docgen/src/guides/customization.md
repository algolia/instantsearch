...
Now you can [read more about connectors](https://community.algolia.com/instantsearch.js/v2/connectors.html) in the docs and create more advanced usages with the same simplicity.  
